...
<body>
    <?php
        ...
        $sql = "SELECT * FROM matakuliah WHERE id='".$kode_mk."'";
     ...
     ?>       
        <form method="POST" id="updatematkul">
            <div class="form-group">
                ...
                <input id="kode_mk" class="form-control" type="text" name="kode_mk" value="<?php echo $row['kode_mk'] ?>" required><br>
            </div>

            <div class="form-group">
                <label>Nama Mata Kuliah</label><br>
                <input id="nama_mk" class="form-control" type="text" name="nama_mk" value="<?php echo $row['nama_mk'] ?>" required><br>
            </div>

            <div class="form-group">
                <label>Kategori</label><br>
                <select id="kategori_mk" class="form-control" name="kategori_mk" required>
        ...
        $(document).ready(function() {
            ...
            $('#simpan').click(function(){
                ...
                $.ajax({
                    ...
                    data: data,
                    success: function() {
                        window.location.href = "edit_mk.php?kodemk="+id+"&suksesedit";
                        $('#sukses').show();
                    }
                });
            })
